(module
 ...
 (global $cubehash/Uint8Array_ID i32 (i32.const 3))
 ...
 (data (i32.const 1772) "A\00\00\00\02\00\00\00\01\01\00\00\02")
 (export "Uint8Array_ID" (global $cubehash/Uint8Array_ID))
 ...
 (export "hash" (func $export:cubehash/hash))
 (start $~start)
 ...
 (func $cubehash/round (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $cubehash/hash (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (result i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
  (local $9 i32)
 ...
 (func $export:cubehash/hash (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
